        ...
        return (
          <div key={idx} className={`relative flex flex-col md:flex-row items-center gap-6 md:gap-0 ${isDescriptionLeft ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
            <div className="w-full md:w-1/2 px-4 md:px-12 text-center md:text-left">
              ...
              {item.fact && <div className="inline-block bg-gray-50 px-2 py-1 rounded-lg border border-gray-100 text-[10px] font-bold text-gray-400 italic">{item.fact}</div>}
            </div>
...
const TokyoTour = () => {
  ...
  const courses = [
    {
      title: "Classic & Pop Tokyo",
      schedule: [
        { location: "Shibuya Crossing", desc: "Start at the world's busiest intersection.", img: "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&q=80", fact: "Over 3,000 people cross at once" },
        { location: "Harajuku Takeshita Street", desc: "Dive into Japan's unique teen fashion and street food.", img: "https://images.unsplash.com/photo-1526481280693-3bfa7568e0f3?auto=format&fit=crop&q=80" },
        { location: "Meiji Jingu Shrine", desc: "A serene forest oasis in the heart of the city.", img: "https://images.unsplash.com/photo-1554797589-723ffbf0d897?auto=format&fit=crop&q=80" },
        { location: "Shinjuku Omoide Yokocho", desc: "Evening explore of 'Memory Lane' with its narrow yakitori stalls.", img: "https://images.unsplash.com/photo-1503899036084-c55cdd92da26?auto=format&fit=crop&q=80" }
      ]
    },
    {
      title: "Retro & Old Tokyo",
      schedule: [
        { location: "Yanaka Ginza", desc: "Experience the nostalgic 'Shitamachi' atmosphere.", img: "https://images.unsplash.com/photo-1570650943149-612668586036?auto=format&fit=crop&q=80", fact: "Nicknamed 'Cat Town'" },
        { location: "Ueno Park & Ameyoko", desc: "Vibrant markets and cultural museums.", img: "https://images.unsplash.com/photo-1583344607374-2c938f381014?auto=format&fit=crop&q=80" },
        { location: "Asakusa Senso-ji", desc: "Visit Tokyo's oldest temple and the famous Kaminarimon gate.", img: "https://images.unsplash.com/photo-1545569341-9eb8b30979d9?auto=format&fit=crop&q=80" }
      ]
    }
  ];
    ...
    <div className="bg-white">
      <section className="relative pt-24 pb-16 px-4 bg-howzit-dark overflow-hidden text-center">
        <div className="max-w-6xl mx-auto relative z-10">
          <h1 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tight font-heading">Tokyo <span className="text-howzit-red">Private Walk</span></h1>
          <div className="max-w-4xl mx-auto rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white/5 bg-black aspect-video relative">
            <iframe className="w-full h-full" src="https://www.youtube.com/embed/Ssh71hePR8Q" title="Tokyo Tour" frameBorder="0" allowFullScreen></iframe>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-gray-100">
              ...
              <div className="bg-howzit-red/5 p-8 rounded-[2.5rem] border border-howzit-red/10">
                ...
                <div className="flex items-baseline gap-2"><span className="text-4xl font-black text-howzit-dark font-heading">¥45,000〜</span><span className="text-sm font-bold text-gray-400">(per group)</span></div>
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-5xl font-black mb-3 tracking-tighter font-heading">Tokyo Courses</h2>
