  ...
  const courses = [
    {
      ...
      schedule: [
        { location: "Kinkaku-ji (Golden Pavilion)", desc: "Witness the stunning gold leaf reflected in the pond.", img: "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&q=80" },
        { location: "Ryoan-ji Zen Garden", desc: "Reflect at Japan's most famous rock garden.", img: "https://images.unsplash.com/photo-1542051841857-5f90071e7989?auto=format&fit=crop&q=80" },
        { location: "Arashiyama Bamboo Grove", desc: "A walk through the towering green bamboo stalks.", img: "https://images.unsplash.com/photo-1590559899731-397e79477e32?auto=format&fit=crop&q=80" }
      ]
    },
    {
      title: "Gion & Old Streets",
      schedule: [
        { location: "Kiyomizu-dera", desc: "Legendary wooden stage with city views.", img: "https://images.unsplash.com/photo-1472396961693-142e6e269027?auto=format&fit=crop&q=80" },
        { location: "Sannenzaka & Ninenzaka", desc: "Charming preserved streets filled with tea houses.", img: "https://images.unsplash.com/photo-1528164344705-47542687000d?auto=format&fit=crop&q=80" },
        { location: "Gion District", desc: "Search for Geiko and Maiko in the historic lantern-lit alleys.", img: "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&q=80" }
      ]
    }
  ];
    ...
    <div className="bg-white">
      <section className="relative pt-24 pb-16 px-4 bg-howzit-dark overflow-hidden text-center">
        <div className="max-w-6xl mx-auto relative z-10">
          <h1 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tight font-heading">Kyoto <span className="text-howzit-red">Bespoke Walk</span></h1>
          <div className="max-w-4xl mx-auto rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white/5 bg-black aspect-video relative">
            <iframe className="w-full h-full" src="https://www.youtube.com/embed/Ssh71hePR8Q" title="Kyoto Tour" frameBorder="0" allowFullScreen></iframe>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-gray-100">
              ...
              <div className="bg-howzit-red/5 p-8 rounded-[2.5rem] border border-howzit-red/10">
                ...
                <div className="flex items-baseline gap-2"><span className="text-4xl font-black text-howzit-dark font-heading">¥50,000〜</span><span className="text-sm font-bold text-gray-400">(per group)</span></div>
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-5xl font-black mb-3 tracking-tighter font-heading">Kyoto Courses</h2>
      ...
      <section className="py-16 bg-gray-50 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-black mb-2 font-heading">Kyoto Walk FAQ</h2>
          </div>
          <div className="bg-white rounded-[2.5rem] p-6 md:p-10 shadow-sm border border-gray-100">
            <FAQItem question="Are temple entrance fees included?" answer="Entrance fees (typically ¥500-¥1,000 per temple) are not included and should be paid on-site." />
            <FAQItem question="Can we customize the route?" answer="Absolutely. Kyoto is dense with history; we can swap locations based on your specific interests in Zen, gardens, or shopping." />
            <FAQItem question="Is this tour walking only?" answer="We use a combination of walking, city buses, and occasionally taxis to ensure we maximize your time while feeling the city's atmosphere." />
          </div>
        </div>
      </section>
    </div>
