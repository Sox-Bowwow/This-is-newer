...
const GroupTour = () => {
  ...
  const problemSolutions = [
    { 
      q: 'Coordinating 10+ people movement', 
      a: 'Expert Group Logistics Control',
      icon: Users2,
    },
    { 
      q: 'Finding restaurants for large groups', 
      a: 'Group-friendly Dining Curation',
      icon: MessageSquare,
    },
    { 
      q: 'Private bus vs. Train logistics', 
      a: 'Optimized Fleet Sourcing',
      icon: Train,
    },
    { 
      q: 'Keeping diverse ages engaged', 
      a: "Flexible Multi-Guide System",
      icon: Sparkles,
    },
    { 
      q: 'PR/Brand filming requirements', 
      a: 'Media-Ready Location Support',
      icon: CameraIcon,
    },
  ];
      ...
      <section className="py-24 px-4 bg-gray-50 rounded-[4rem] mx-4 shadow-inner">
         ...
         <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <InstagramPost 
              ...
              desc="Corporate group (approx. 10 people). A 1-day fully custom tour in Tokyo, perfectly blending business objectives with authentic sightseeing."
            />
            <InstagramPost 
              title="Academic Exchange"
              category="School"
              location="Kyoto"
              img="https://images.unsplash.com/photo-152305085306e-8c3d3e7d4f1a?auto=crop&w=800&q=80"
              desc="School visit arrangements. Immersive Japanese cultural experiences and curated introductions to local secret spots for students."
            />
            <InstagramPost 
              title="Global Brand PR"
              category="Media/PR"
              location="Osaka"
              img="https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&q=80"
              desc="Brand PR tour (approx. 15 people). Hosting creators and staff with dedicated filming support at local sushi shops and SNS-ready location scouting."
            />
         </div>
      </section>
